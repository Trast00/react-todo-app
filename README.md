...
**React-todo-app** is a todo list webapp project created with react Js for learning purpose. You can add, edit, delte tasks from you list stored in the local storage
